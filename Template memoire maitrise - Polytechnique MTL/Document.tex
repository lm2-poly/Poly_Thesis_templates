...
%%
%%  Gabarit bilingue de mémoire de maîtrise ou thèse de doctorat adapté pour prof. Frédérick Gosselin.
%%  Bilingual template for dissertations and theses @ Polytechnique Montreal adapted for prof. Frédérick Gosselin.
...
\include{7-Synthese_Revue_Objectifs} % Synthèse de la revue de littérature et des objectifs / Synthesis of the literature review and objectives
\include{8-Theme1}             % Premier thème (Doctorat) ou "Détails de la Solution" (Maîtrise) / First topic (PhD) or "Details of the Solution" (Master's).
\include{8-Theme2}             % Second thème (Doctorat) ou "Résultats théoriques et expérimentaux" (Maîtrise) / Second theme (PhD) or "Theoretical and experimental results" (Master's)
\include{8-Theme3}             % Troisième thème (Doctorat) ou effacez ce fichier si vous êtes à la Maîtrise / Third topic (PhD) or delete this file if you are in the Master's program
\include{9-Conclusion}         % Conclusion.
%\backmatter
\ifthenelse{\equal{\Langue}{english}}{
	...
	\bibliography{Document}
	\bibliographystyle{apalike} 				  % Style bibliographique / Bibliography style
