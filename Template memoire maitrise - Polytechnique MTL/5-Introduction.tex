...
%%
%% FG  LE TEMPLATE DE BASE DE POLYTECHNIQUE FAIT USAGE DE BEAUCOUP DE
%% NIVEAUX DE SOUS-SECTIONS. ALLEZ-Y AVEC MODÉRATION. SURTOUT EN
%% CHAPITRE D'INTRODUCTION, IL N'EST PAS NÉCESSAIRE DE DÉPASSER UN OU
%% DEUX NIVEAUX DE SOUS-SECTIONS.
%%
...
%%
\section{Contexte et problématique}  % environ 1 à 3 pages
...
%% Motivation
%%
\section{Motivation}  % Environ 2 à 3 page
